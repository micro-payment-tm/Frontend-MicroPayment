...
import { LogOut, Bitcoin, DollarSign, TrendingUp, Activity, Send, Plus, CreditCard, Eye, EyeOff, Lock, Bell, Settings, Menu, X, ArrowRight } from 'lucide-react';
...
export default function DashboardPage() {
  ...
  const transactions = [
    { id: 1, type: 'Collateral Deposit', amount: 0.25, date: '2024-01-15', status: 'completed', icon: Bitcoin },
    { id: 2, type: 'MUSD Minted', amount: 7500, date: '2024-01-14', status: 'completed', icon: Plus },
    { id: 3, type: 'Yield Earned', amount: 108.33, date: '2024-01-10', status: 'completed', icon: TrendingUp },
    { id: 4, type: 'P2P Transfer', amount: 500, date: '2024-01-08', status: 'completed', icon: Send },
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-blue-900 to-slate-950">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="hidden md:flex items-center gap-4">
                ...
                <button
                  ...
                  className="flex items-center gap-2 bg-red-600 hover:bg-red-700 text-white px-3 py-2 rounded-lg transition-all text-sm"
                >
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {/* Welcome Section */}
        <div className="mb-8">
          <h2 className="text-3xl font-bold text-white mb-2">Welcome back, {user.full_name}!</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-gradient-to-br from-emerald-900/40 to-emerald-950/40 border border-emerald-500/20 rounded-2xl p-6 backdrop-blur-xl hover:border-emerald-400/40 transition-all duration-300">
            ...
            <div className="space-y-2">
              ...
              <div className="text-xs text-emerald-400">1 MUSD = $1 USD</div>
            </div>
          </div>
            ...
            <div className="bg-gradient-to-br from-slate-900/60 to-slate-800/60 border border-slate-700/50 rounded-2xl p-6 backdrop-blur-xl">
              ...
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <div className="text-lg font-bold text-white">Annual APR</div>
                </div>
              </div>
            </div>
